...
ruls = (f.render('идти вверх - стрелка вверх', False, (255, 0, 0)),
        f.render('идти вниз - стрелка вниз', False, (255, 0, 0)),
        f.render('идти вправо - стрелка вправо', False, (255, 0, 0)),
        f.render('идти влево - стрелка влево', False, (255, 0, 0)),
        f.render('дойди до зелёного', False, (255, 0, 0)),
        ) #правила игры
