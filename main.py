...
class Player(pg.sprite.Sprite):  # класс игрока
    ...
    def __init__(self):
        ...
        self.image = pg.Surface((50, 50))  # размер персонажа
...
class Vrag(pg.sprite.Sprite):  # класс врага
    ...
    def __init__(self, x, y):
        pg.sprite.Sprite.__init__(self)
        self.image = pg.Surface((50, 50))  # размер врага
        self.rect = self.image.get_rect()  # создание "хитбокса"
...
vrag_image = pg.image.load('2.png').convert_alpha()  # загрузка изображения врага
crop_vrag_image = pg.transform.scale(vrag_image, (50, 50))  # уменьшение изображения до 50х50
...
for i in range(0, 8):  # цикл создания врагов
    ...
    vrags[i].image = crop_vrag_image  # наложение на врагов изображений
...
vrag_image = pg.image.load('1.jpg').convert_alpha()  # загрузка изображения персонажа
crop_vrag_image = pg.transform.scale(vrag_image, (50, 50))  # изменение разера изображения
player.image = crop_vrag_image  # наложение изображение на игрока
